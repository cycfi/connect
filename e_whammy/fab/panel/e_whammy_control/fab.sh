kikit panelize \
    ...
    ../../../e_whammy_control.kicad_pcb e_whammy_control_panel.kicad_pcb

kikit fab jlcpcb --no-drc --assembly --schematic ../../../e_whammy_control.kicad_sch e_whammy_control_panel.kicad_pcb .
mv gerbers.zip e_whammy_control_gerbers.zip
