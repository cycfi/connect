kikit panelize \
    ...
    --post 'millradius: 1mm' \
    ../audio_pot_big.kicad_pcb audio_pot_big_panel.kicad_pcb

kikit fab jlcpcb --no-drc --assembly --schematic ../audio_pot_big.kicad_sch audio_pot_big_panel.kicad_pcb .
mv gerbers.zip audio_pot_big_gerbers.zip
