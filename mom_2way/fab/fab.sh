kikit panelize \
    ...
    --post 'millradius: 1mm' \
    ../mom_2way.kicad_pcb mom_2way_panel.kicad_pcb

kikit fab jlcpcb --no-drc --assembly --schematic ../mom_2way.kicad_sch mom_2way_panel.kicad_pcb .
mv gerbers.zip mom_2way_gerbers.zip
